...
impl SpringConfig {
    ...
    fn calculate_underdamped(&self, time: f32, displacement: f32, angular_frequency: f32, damping_ratio: f32) -> f32 {
    ...
    fn calculate_critically_damped(&self, time: f32, displacement: f32, angular_frequency: f32) -> f32 {
        let a = displacement;
    ...
    fn calculate_overdamped(&self, time: f32, displacement: f32, angular_frequency: f32, damping_ratio: f32) -> f32 {
    ...
    pub fn calculate_velocity(&self, time: f32, from: f32, to: f32) -> f32 {
        ...
        if damping_ratio < 1.0 {
            ...
            let oscillation = a * (damped_frequency * time).cos() + b * (damped_frequency * time).sin();
            let oscillation_derivative = damped_frequency * (-a * (damped_frequency * time).sin() + b * (damped_frequency * time).cos());
...
pub fn spring_with_velocity(mass: f32, stiffness: f32, damping: f32, velocity: f32) -> SpringConfig {
