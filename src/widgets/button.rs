...
impl Button {
    ...
    pub fn render_with_utilities(
        ...
        let rendered_content = match self.style.border_style {
            ...
            ButtonBorderStyle::OrnamentalParens => self.render_ornamental_parens(
                layout,
                button_text,
                padding_h,
                padding_v,
...
impl Button {
    ...
    pub fn to_element(&self) -> crate::components::Element {
        ...
        let mut element = Element::with_tag("button")
            ...
            .attr("role", "button")
            .attr("type", match self.button_type {
        ...
        element = element.class(&format!("button-{}", match self.button_type {
            ButtonType::Primary => "primary",
            ButtonType::Secondary => "secondary",
            ButtonType::Danger => "danger",
            ButtonType::Success => "success",
    ...
    pub fn render_with_layout(&self, layout: &crate::layout::LayoutRect, theme: Option<&crate::themes::ColorTheme>) -> String {
