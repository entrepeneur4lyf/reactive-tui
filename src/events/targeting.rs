...
impl MouseTargeting {
    ...
    pub fn update_component_bounds(&mut self, element_id: String, bounds: Bounds, z_index: i32, is_interactive: bool) {
    ...
    fn collect_component_bounds_recursive(&mut self, element: &Element, layout: &Layout, default_z_index: i32) {
