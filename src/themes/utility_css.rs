...
pub fn default_utility_palette() -> UtilityPalette {
  UtilityPalette {
    ...
    gray_50: hex("#f8fafc").unwrap(),
    gray_100: hex("#f1f5f9").unwrap(),
    gray_200: hex("#e2e8f0").unwrap(),
    gray_300: hex("#cbd5e1").unwrap(),
    gray_400: hex("#94a3b8").unwrap(),
    gray_500: hex("#64748b").unwrap(),
    gray_600: hex("#475569").unwrap(),
    gray_700: hex("#334155").unwrap(),
    gray_800: hex("#1e293b").unwrap(),
    gray_900: hex("#0f172a").unwrap(),
    gray_950: hex("#020617").unwrap(),

    // Blue (updated to match Tailwind v3.4+)
    blue_50: hex("#eff6ff").unwrap(),
    blue_100: hex("#dbeafe").unwrap(),
    blue_200: hex("#bfdbfe").unwrap(),
    blue_300: hex("#93c5fd").unwrap(),
    blue_400: hex("#60a5fa").unwrap(),
    blue_500: hex("#3b82f6").unwrap(),
    blue_600: hex("#2563eb").unwrap(),
    blue_700: hex("#1d4ed8").unwrap(),
    blue_800: hex("#1e40af").unwrap(),
    blue_900: hex("#1e3a8a").unwrap(),
    blue_950: hex("#172554").unwrap(),

    // Green (updated to match Tailwind v3.4+)
    green_50: hex("#f0fdf4").unwrap(),
    green_100: hex("#dcfce7").unwrap(),
    green_200: hex("#bbf7d0").unwrap(),
    green_300: hex("#86efac").unwrap(),
    green_400: hex("#4ade80").unwrap(),
    green_500: hex("#22c55e").unwrap(),
    green_600: hex("#16a34a").unwrap(),
    green_700: hex("#15803d").unwrap(),
    green_800: hex("#166534").unwrap(),
    green_900: hex("#14532d").unwrap(),
    green_950: hex("#052e16").unwrap(),

    // Red (updated to match Tailwind v3.4+)
    red_50: hex("#fef2f2").unwrap(),
    red_100: hex("#fee2e2").unwrap(),
    red_200: hex("#fecaca").unwrap(),
    red_300: hex("#fca5a5").unwrap(),
    red_400: hex("#f87171").unwrap(),
    red_500: hex("#ef4444").unwrap(),
    red_600: hex("#dc2626").unwrap(),
    red_700: hex("#b91c1c").unwrap(),
    red_800: hex("#991b1b").unwrap(),
    red_900: hex("#7f1d1d").unwrap(),
    red_950: hex("#450a0a").unwrap(),

    // Amber (Tailwind's primary yellow)
    yellow_50: hex("#fffbeb").unwrap(),
    yellow_100: hex("#fef3c7").unwrap(),
    yellow_200: hex("#fde68a").unwrap(),
    yellow_300: hex("#fcd34d").unwrap(),
    yellow_400: hex("#fbbf24").unwrap(),
    yellow_500: hex("#f59e0b").unwrap(),
    yellow_600: hex("#d97706").unwrap(),
    yellow_700: hex("#b45309").unwrap(),
    yellow_800: hex("#92400e").unwrap(),
    yellow_900: hex("#78350f").unwrap(),
    yellow_950: hex("#451a03").unwrap(),

    // Violet (Tailwind's primary purple)
    purple_50: hex("#f5f3ff").unwrap(),
    purple_100: hex("#ede9fe").unwrap(),
    purple_200: hex("#ddd6fe").unwrap(),
    purple_300: hex("#c4b5fd").unwrap(),
    purple_400: hex("#a78bfa").unwrap(),
    purple_500: hex("#8b5cf6").unwrap(),
    purple_600: hex("#7c3aed").unwrap(),
    purple_700: hex("#6d28d9").unwrap(),
    purple_800: hex("#5b21b6").unwrap(),
    purple_900: hex("#4c1d95").unwrap(),
    purple_950: hex("#2e1065").unwrap(),

    // Orange (updated to match Tailwind v3.4+)
    orange_50: hex("#fff7ed").unwrap(),
    orange_100: hex("#ffedd5").unwrap(),
    orange_200: hex("#fed7aa").unwrap(),
    orange_300: hex("#fdba74").unwrap(),
    orange_400: hex("#fb923c").unwrap(),
    orange_500: hex("#f97316").unwrap(),
    orange_600: hex("#ea580c").unwrap(),
    orange_700: hex("#c2410c").unwrap(),
    orange_800: hex("#9a3412").unwrap(),
    orange_900: hex("#7c2d12").unwrap(),
    orange_950: hex("#431407").unwrap(),

    // Emerald (updated to match Tailwind v3.4+)
    emerald_50: hex("#ecfdf5").unwrap(),
    emerald_100: hex("#d1fae5").unwrap(),
    emerald_200: hex("#a7f3d0").unwrap(),
    emerald_300: hex("#6ee7b7").unwrap(),
    emerald_400: hex("#34d399").unwrap(),
    emerald_500: hex("#10b981").unwrap(),
    emerald_600: hex("#059669").unwrap(),
    emerald_700: hex("#047857").unwrap(),
    emerald_800: hex("#065f46").unwrap(),
    emerald_900: hex("#064e3b").unwrap(),
    emerald_950: hex("#022c22").unwrap(),

    // Cyan (updated to match Tailwind v3.4+)
    cyan_50: hex("#ecfeff").unwrap(),
    cyan_100: hex("#cffafe").unwrap(),
    cyan_200: hex("#a5f3fc").unwrap(),
    cyan_300: hex("#67e8f9").unwrap(),
    cyan_400: hex("#22d3ee").unwrap(),
    cyan_500: hex("#06b6d4").unwrap(),
    cyan_600: hex("#0891b2").unwrap(),
    cyan_700: hex("#0e7490").unwrap(),
    cyan_800: hex("#155e75").unwrap(),
    cyan_900: hex("#164e63").unwrap(),
    cyan_950: hex("#083344").unwrap(),

    // Indigo (updated to match Tailwind v3.4+)
    indigo_50: hex("#eef2ff").unwrap(),
    indigo_100: hex("#e0e7ff").unwrap(),
    indigo_200: hex("#c7d2fe").unwrap(),
    indigo_300: hex("#a5b4fc").unwrap(),
    indigo_400: hex("#818cf8").unwrap(),
    indigo_500: hex("#6366f1").unwrap(),
    indigo_600: hex("#4f46e5").unwrap(),
    indigo_700: hex("#4338ca").unwrap(),
    indigo_800: hex("#3730a3").unwrap(),
    indigo_900: hex("#312e81").unwrap(),
    indigo_950: hex("#1e1b4b").unwrap(),

    // Pink (updated to match Tailwind v3.4+)
    pink_50: hex("#fdf2f8").unwrap(),
    pink_100: hex("#fce7f3").unwrap(),
    pink_200: hex("#fbcfe8").unwrap(),
    pink_300: hex("#f9a8d4").unwrap(),
    pink_400: hex("#f472b6").unwrap(),
    pink_500: hex("#ec4899").unwrap(),
    pink_600: hex("#db2777").unwrap(),
    pink_700: hex("#be185d").unwrap(),
    pink_800: hex("#9d174d").unwrap(),
    pink_900: hex("#831843").unwrap(),
    pink_950: hex("#500724").unwrap(),
