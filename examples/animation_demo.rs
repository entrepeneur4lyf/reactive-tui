...
impl AnimationDemo {
        ...
        match phase {
            ...
            4 => {
                ...
                if let Some(animation) =
                    self.animation_manager.get_animation_mut("elastic-sequence")
                {
                    animation.play();
                }
            }
    ...
    fn render(&self) -> String {
        ...
        output
            .push_str("• Property Animations (Opacity, Position, Size, Color, Scale, Rotation)\n");
        ...
        output.push_str(
            "• Performance Optimization (Frame-based timing, Efficient interpolation)\n\n",
        );
        ...
        match self.current_phase {
            0 => {
                output.push_str("Basic fade in/out animations with different durations and delays")
            }
            1 => output
                .push_str("Showcase of 10 different easing functions with position animations"),
            2 => output.push_str(
                "Property animations: color transitions, scaling, rotation, multi-property",
            ),
            3 => output
                .push_str("Timeline sequences: sequential and parallel animation coordination"),
            4 => output.push_str(
                "Complex compositions: staggered entrances, wave effects, elastic sequences",
            ),
