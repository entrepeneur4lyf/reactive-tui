...
use tui_core::components::main as main_element;
use tui_core::components::{div, footer, header, section, text};
                ...
                main_element()
                    ...
                    .child_builder(
                        section()
                            ...
                            .class("p-2")
                            .child_builder(
                                div().class("h-1/4").child_builder(text("Vertical Layout")),
                            )
                            .child_builder(
                                div()
                                    .class("flex-1")
                                    ...
                                    .class("flex-col")
                                    .child_builder(
                                        div().class("h-1/3").child_builder(text("Header")),
                                    )
                                    .child_builder(
                                        div().class("flex-1").child_builder(text("Content")),
                                    )
                                    .child_builder(
                                        div().class("h-1/3").child_builder(text("Footer")),
                                    ),
                            ),
                    )
                    .child_builder(
                        section()
                            ...
                            .child_builder(
                                div()
                                    ...
                                    .child_builder(
                                        div().class("flex-1").child_builder(text("Center")),
                                    )
                                    .child_builder(
                                        div().class("w-1/3").child_builder(text("Right")),
                                    ),
                            ),
                    ),
            )
