...
use reactive_tui::components::{button, div, text, Element};
use reactive_tui::events::ActionResult;
        ...
        div()
          ...
          .child(
            div()
              .class("actions")
              .class("mt-4")
              .child(button().child(text("Edit Profile").build()).build())
              .child(
                button()
...
impl MultiScreenApp {
  async fn new() -> Result<Self> {
    ...
    screen_manager
      .register(Box::new(SettingsScreen::new()))
      .await?;
    screen_manager
      .register(Box::new(ProfileScreen::new()))
      .await?;
    screen_manager
      .register(Box::new(DashboardScreen::new()))
      .await?;
